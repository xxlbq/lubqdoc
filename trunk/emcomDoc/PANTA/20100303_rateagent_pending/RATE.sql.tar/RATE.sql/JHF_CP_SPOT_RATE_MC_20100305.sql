...
--
-- Table structure for table `JHF_CP_SPOT_RATE_MC_20100305`
--

DROP TABLE IF EXISTS `JHF_CP_SPOT_RATE_MC_20100305`;
CREATE TABLE `JHF_CP_SPOT_RATE_MC_20100305` (
...
--
-- Dumping data for table `JHF_CP_SPOT_RATE_MC_20100305`
--
-- WHERE:  INPUT_DATE >= '2010-03-05 22:29:00' and INPUT_DATE <= '2010-03-05 22:31:59'

LOCK TABLES `JHF_CP_SPOT_RATE_MC_20100305` WRITE;
/*!40000 ALTER TABLE `JHF_CP_SPOT_RATE_MC_20100305` DISABLE KEYS */;
/*!40000 ALTER TABLE `JHF_CP_SPOT_RATE_MC_20100305` ENABLE KEYS */;
UNLOCK TABLES;
