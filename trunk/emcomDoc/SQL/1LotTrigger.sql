...
SELECT * FROM JHF_ALIVE_ORDER WHERE ORDER_ID='20090205ORD00011801';
...
SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009020500024163','',''));
...
WHERE ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN( '2009020500024162','','')  ) ORDER BY ID\G; 


SELECT * FROM JHF_HEDGE_CUSTTRADE_HISTORY 
WHERE ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN('','','')  ) ORDER BY ID\G; 
...
SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN( '2009020500024163','','')  )) ORDER BY ID\G; 
