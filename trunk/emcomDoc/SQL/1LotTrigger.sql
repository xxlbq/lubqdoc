...
SELECT * FROM JHF_ALIVE_ORDER WHERE ORDER_ID='20090202ORD00002205'\G;


-- ORDER_BIND_ID 查询execution
SELECT ORDER_ID,EXECUTION_ID ,SIDE,EXECUTION_PRICE,EXECUTION_AMOUNT FROM JHF_EXECUTION WHERE ORDER_ID IN (
SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009020200002904','',''));
...
WHERE ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN( '2009020200002901','2009020200002902','2009020200002903')  ) ORDER BY ID\G; 
...
SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN( '2009020200002904','','')  )) ORDER BY ID\G; 
...
SELECT * FROM JHF_HEDGE_CUSTTRADE_HISTORY 
WHERE ID IN (SELECT  EXECUTION_ID  FROM JHF_EXECUTION WHERE ORDER_ID IN (
SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN( '2009020200002901','2009020200002902','2009020200002903')  )) ORDER BY ID\G; 
