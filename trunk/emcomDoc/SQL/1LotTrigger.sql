...
SELECT ORDER_ID,ORDER_AMOUNT,SIDE, ORDER_BIND_ID FROM JHF_ALIVE_ORDER WHERE CUSTOMER_ID = '00000120' AND ORDER_BIND_ID='2009022700032704'  ORDER BY INPUT_DATE ,SIDE DESC;
...
SELECT * FROM JHF_ALIVE_ORDER WHERE CUSTOMER_ID = '00008101' ORDER BY INPUT_DATE DESC;
...
VALUES('BLACKLIST', 'BLACKLIST_MODE', '0', '成行注文の非滞留モード', '#0:1Lot Stay&Trigger , #1:Normal BlackList,Not Stay ', 'system', 'system', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
select * from JHF_ALIVE_ORDER where order_bind_id = '2009022700032704';

SELECT * FROM JHF_EXECUTION WHERE ORDER_ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009022700032704',''));

SELECT * FROM JHF_EXECUTION_BIND WHERE EXECUTION_ID IN (SELECT EXECUTION_ID FROM JHF_EXECUTION WHERE ORDER_ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009022700032704',''))) ;

SELECT * FROM JHF_ALIVE_CONTRACT WHERE ORDER_ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009022700032704',''));

SELECT * FROM JHF_SYS_POSITION_INSERT 
WHERE POSITION_SOURCE_ID IN (
    SELECT EXECUTION_ID FROM JHF_EXECUTION WHERE ORDER_ID IN (
        SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009022700032704','')
) )ORDER BY INPUT_DATE DESC; 


SELECT * FROM JHF_CONTRACT_BIND WHERE EXECUTION_ID IN (SELECT EXECUTION_ID FROM JHF_EXECUTION WHERE ORDER_ID IN (SELECT ORDER_ID FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID IN ('2009022700032704','')));




SELECT * FROM JHF_ALIVE_CONTRACT WHERE ORDER_ID = '20090227ORD00021719'

SELECT * FROM JHF_FINISHED_CONTRACT WHERE ORDER_ID = '20090227ORD00021719'
