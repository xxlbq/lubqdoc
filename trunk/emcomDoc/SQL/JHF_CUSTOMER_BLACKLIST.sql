...
SELECT * FROM JHF_ORDER_BIND WHERE ORDER_BIND_ID = '2008080600009555'
...
SELECT * FROM JHF_COUNTERPARTY_CURRENCYPAIR ;
SELECT * FROM JHF_STATUS_CONTRL WHERE CURRENCY_PAIR = 'AUD/JPY'
...
SELECT ORDER_ID ,ORDER_STATUS,UPDATE_DATE,CUSTOMER_ID ,INPUT_DATE,UPDATE_DATE,EXECUTION_PRICE,SIDE,ORDER_AMOUNT FROM JHF_ALIVE_ORDER ORDER BY INPUT_DATE DESC

-- JHF_ALIVE_ORDER

SELECT ORDER_ID ,ORDER_STATUS,CUSTOMER_ID ,INPUT_DATE,UPDATE_DATE,TRADE_PRICE, EXECUTION_PRICE,SIDE,ORDER_AMOUNT ,PRICE_ID,CHANGE_REASON ,UPDATE_STAFF_ID ,SETTLE_CONTRACT_ID,ACTIVATION_DATE,EXPIRATION_DATE ,REVISION_NUMBER 
FROM JHF_ALIVE_ORDER WHERE ORDER_BIND_ID='2009020500024163' ORDER BY INPUT_DATE DESC

-- JHF_ORDER_STATUS_HISTORY
SELECT ORDER_ID ,ORDER_STATUS,CUSTOMER_ID ,INPUT_DATE,UPDATE_DATE,TRADE_PRICE, EXECUTION_PRICE,SIDE,ORDER_AMOUNT ,PRICE_ID,CHANGE_REASON ,UPDATE_STAFF_ID ,SETTLE_CONTRACT_ID,ACTIVATION_DATE,EXPIRATION_DATE ,REVISION_NUMBER 
FROM JHF_ORDER_STATUS_HISTORY WHERE ORDER_BIND_ID='2009020500024163' ORDER BY INPUT_DATE DESC
