...
UPDATE JHF_APPLICATION_DATE SET FRONT_DATE = '20090914' WHERE DATE_KEY IN ('F','S');

UPDATE JHF_APPLICATION_DATE SET FRONT_DATE = '20090913' WHERE DATE_KEY IN ('B');

UPDATE JHF_ALIVE_ORDER SET ACTIVATION_DATE = DATE_SUB(CURRENT_TIMESTAMP, interval 10 HOUR) WHERE ORDER_ID='TstORD_0'


UPDATE JHF_APPLICATION_DATE SET FRONT_END_DATETIME = '2011-9-15 05:50:00' WHERE DATE_KEY IN ('F','S');
