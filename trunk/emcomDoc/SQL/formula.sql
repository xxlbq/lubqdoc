...
SELECT CASHFLOW_ID,CASHFLOW_AMOUNT,VALUE_DATE,CASHFLOW_TYPE FROM JHF_UNREALIZED_CASHFLOW WHERE CUSTOMER_ID = '00000101' AND VALUE_DATE > (SELECT FRONT_DATE FROM JHF_APPLICATION_DATE WHERE DATE_KEY='F') ;

UPDATE JHF_UNREALIZED_CASHFLOW SET CASHFLOW_AMOUNT = '-800000' WHERE CASHFLOW_ID = '20100309CASH01258965';
UPDATE JHF_UNREALIZED_CASHFLOW SET VALUE_DATE = '20100610' WHERE CASHFLOW_ID = '20100309CASH01258965';

SELECT CASHFLOW_ID,SUM(CASHFLOW_AMOUNT),VALUE_DATE,CASHFLOW_TYPE FROM JHF_UNREALIZED_CASHFLOW 
WHERE CUSTOMER_ID = '00060101' AND VALUE_DATE > (SELECT FRONT_DATE FROM JHF_APPLICATION_DATE WHERE DATE_KEY='F') GROUP BY VALUE_DATE
